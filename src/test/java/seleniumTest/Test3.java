...
public class Test3 extends Driver {
    ...
    private final By checkboxDemo = By.xpath("//div[@id='easycont']//a[text()='Checkbox Demo']");
    private final By option1 = By.xpath("//label[text()='Option 1']");
    private final By option3 = By.xpath("//label[text()='Option 3']");
